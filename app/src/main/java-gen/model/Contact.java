...
public class Contact {
    ...
    public Contact(Long id, int memberId, int contactId, String email, String name, String headBig, String headSmall, java.util.Date registerTime, java.util.Date createTime, String pinyin) {
        this.id = id;
